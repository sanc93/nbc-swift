...
- Lv4 : AddOperation(더하기), SubtractOperation(빼기), MultiplyOperation(곱하기), DivideOperation(나누기)
        연산 클래스들을 AbstractOperation라는 클래스명으로 만들어 사용하여 추상화하고 Calculator 클래스의 내부 코드를 변경합니다.
 */
...
// 빼기 클래스
class SubstractOperation: AddOperation {
    override func calculate(_ num1: Int, _ num2: Int) -> Int {
        return num1 - num2
   }
}

// 곱하기 클래스
class MultiplyOperation: AddOperation {
    override func calculate(_ num1: Int, _ num2: Int) -> Int {
        return num1 * num2
   }
}
...
// 나누기 클래스
class DivideOperation: AddOperation {
    override func calculate(_ num1: Int, _ num2: Int) -> Int {
        return num1 / num2
   }
}
...
// 나머지 클래스
class ModOperation: AddOperation {
    override func calculate(_ num1: Int, _ num2: Int) -> Int {
        return num1 % num2
   }
}
